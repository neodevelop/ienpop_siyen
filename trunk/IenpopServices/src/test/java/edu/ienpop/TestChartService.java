...
public class TestChartService {
	...
	public void testChartService2() {
		try {
			String[] usuarios = {"RAMIREZ","MAGALI","BORDA","BUSTAMANTE","MENDOZA","MERCADO","SALDIVAR","BORDA"};
			String[] idTipoCurso = {"SEGBAPES","STCW95","INICIA1","CAPACO3234","PATRON_DE_YATE_I","PATRON_DE_YATE_II","PATRON_DE_YATE_III","INICIA1_P"};
			...
			ChartUtilities.saveChartAsPNG(new File("usuarios.png"), chart,1100, 600);
		} catch (BusinessException e) {
			System.out.println(e.getMessage());
		} catch (IOException e) {
			System.out.println(e.getMessage());
