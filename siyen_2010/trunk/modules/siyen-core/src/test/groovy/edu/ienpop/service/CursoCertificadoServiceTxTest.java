 ...
 * 
 */
public class CursoCertificadoServiceTxTest extends AbstractTransactionalJavaConfigBaseClass {

	private static final Log logger = LogFactory.getLog(CursoCertificadoServiceTxTest.class);
	/**
